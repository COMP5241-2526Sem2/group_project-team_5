...
class TextbookSemester(str, enum.Enum):
    VOL1 = "vol1"
    VOL2 = "vol2"
...
class Textbook(Base):
    ...
    semester: Mapped[TextbookSemester] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint("publisher", "grade", "subject", "semester", name="uq_textbooks_identity"),
    )
