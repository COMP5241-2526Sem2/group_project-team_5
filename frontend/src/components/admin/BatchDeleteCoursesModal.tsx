...
interface BatchDeleteCoursesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  courses: Course[];
...
export default function BatchDeleteCoursesModal({
  isOpen,
  onClose,
  onConfirm,
  courses,
}: BatchDeleteCoursesModalProps) {
        ...
        <div className="relative bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 px-8 py-6 text-white overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-1">Batch Delete Courses</h3>
                <p className="text-sm text-white/80">Please review carefully before confirming</p>
              </div>
            </div>
            <motion.button
        ...
        <div className="p-8 space-y-6 max-h-[calc(90vh-200px)] overflow-y-auto">
          ...
          >
            <p className="text-gray-800 text-lg mb-4">
              ...
              <span className="text-red-600 font-bold text-xl">{courses.length}</span>{' '}
          ...
          >
            <div className="flex items-center gap-2 text-gray-700 font-semibold mb-4">
              ...
              <span>Courses to be deleted</span>
            </div>
            <ul className="space-y-3">
              {courses.map((course, index) => (
                ...
                >
                  <div className="w-10 h-10 bg-gradient-to-br from-red-100 to-pink-100 rounded-lg flex items-center justify-center text-red-600 font-semibold">
                    {index + 1}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-medium text-gray-800 truncate">{course.name}</span>
                      <span className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full font-mono flex-shrink-0">
                        {course.code}
                      </span>
                    </div>
          ...
          >
            <div className="text-sm text-gray-700 space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Batch limit: minimum 1, maximum 100 courses.</span>
              </div>
              <div className="flex items-center gap-2">
